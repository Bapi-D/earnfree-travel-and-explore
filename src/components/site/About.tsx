...
// Clean list featuring the brand's primary USPs and service standards
const points = [
      ...
      <div className="container mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          <div className="aspect-square rounded-[2.5rem] glass-card p-12 flex items-center justify-center relative overflow-hidden">
            ...
            <img src={logo} alt="Earnfree logo" className="max-w-[78%] animate-float relative" />
          </div>
          
          {/* UPDATED: Displays the correct 7+ years of experience count */}
          <div className="absolute -bottom-7 -right-4 lg:right-6 bg-gradient-to-br from-primary to-[oklch(0.62_0.21_30)] text-primary-foreground rounded-3xl px-7 py-6 shadow-elegant">
            ...
            <div className="text-sm opacity-90 tracking-wider uppercase">Years of Trust</div>
          </div>
        ...
        >
          ...
          {/* UPDATED: Main business introductory text matching your brand copy */}
          <p className="text-muted-foreground leading-relaxed text-lg -mt-8 mb-8">
            Earnfree Travel And Explore is a trusted name in the Indian travel industry, 
            offering seamless and budget-friendly travel experiences across destinations. 
            We specialize in creating personalized trips that help you explore more while 
            spending smart. From secure bookings and competitive pricing to flights, hotels, 
            and complete tour packages, we focus on comfort, reliability, and unforgettable experiences.
          </p>
